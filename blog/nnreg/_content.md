...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-4-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-6-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-14-output-1.png)
...
(0.0, 1000.0)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-15-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-16-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-18-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-21-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-22-output-1.png)
...
for j in range(io.shape[1]):
    plt.plot(xgrid, io[:, j], lw=2)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-24-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-25-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-27-output-1.png)
...
for j in range(io.shape[1]):
    plt.plot(xgrid, io[:, j], lw=2)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-28-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-29-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-31-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-32-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-34-output-1.png)
...
for j in range(io.shape[1]):
    plt.plot(xgrid, io[:, j], lw=2)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-35-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-36-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-38-output-1.png)
...
for j in range(io.shape[1]):
    plt.plot(xgrid, io[:, j], lw=2)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-39-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-40-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-42-output-1.png)
...
for j in range(io.shape[1]):
    plt.plot(xgrid, io[:, j], lw=2)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-43-output-1.png)
...
plt.plot([a[0] for a in accum]);
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-44-output-1.png)
...
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-46-output-1.png)
...
for j in range(io.shape[1]):
    plt.plot(xgrid, io[:, j], lw=2)
```
![Figure](https://univ.ai/posts/nnreg/index_files/figure-html/cell-47-output-1.png)

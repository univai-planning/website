---
title: "Modernizing Healthcare Fraud Detection via Machine Learning"
subtitle: "An end-to-end Databricks pipeline for prioritizing high-risk healthcare claims before payout."
description: "How feature engineering, embeddings, ensemble models, SHAP interpretability, and drift monitoring helped a healthcare fraud team focus its investigation queue and intercept high-risk claims before payout."
...
categories:
  ...
  - mlops
date: 2026-06-29
image: assets/healthcare-fraud-card.png
---

![Healthcare Integrity Machine Learning Pipeline](assets/healthcare-integrity-ml-pipeline.png)
...
![Receiver Operating Characteristic and Precision-Recall evaluation curves](assets/model-evaluation-curves.png)
...
![The Champion Voting and Clustering framework: three parallel pathways converge into a single prioritized auditor queue](assets/champion-voting-clustering-framework.png)
...
![Global feature importance profile via mean SHAP values. Illustrative example.](assets/shap-feature-importance.png)

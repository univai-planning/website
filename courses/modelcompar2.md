...
subtitle: "WAIC, cross-validation, LOOCV, and practical tips for choosing between models."
description: "Continues the discussion of model comparison with the fully Bayesian WAIC, then covers cross-validation approaches including LOOCV with Pareto-smoothed importance sampling. Includes practical guidance on when to use each method."
categories:
    - bayesian
    - models
    - information-theory

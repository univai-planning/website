...
subtitle: "Proving that Gibbs sampling is a special case of MH with acceptance probability one."
description: "Shows that Gibbs is a special case of a Metropolis-Hastings sampler where proposing from the conditional distribution of each component yields an acceptance probability of 1, eliminating all rejection."
categories:
    - mcmc
    - sampling
    - bayesian

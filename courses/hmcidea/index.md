...
subtitle: "Using momentum and energy conservation to glide efficiently through the typical set."
description: "Conceptual foundation for HMC using typical sets and energy landscapes. Uses physical analogies of orbiting satellites to motivate adding momentum variables and Hamiltonian dynamics for efficient level-set traversal in MCMC."
categories:
    - mcmc
    - sampling
    - optimization

...
subtitle: "From KL-divergence to deviance — AIC, DIC, and WAIC for comparing models."
description: "Information criteria derive from deviance and KL-divergence to estimate out-of-sample predictive performance. We trace the path from frequentist AIC through DIC to the fully Bayesian WAIC, and discuss model comparison vs. model selection."
categories:
    - bayesian
    - models
    - information-theory

...
subtitle: "Fixed parameters, random data — the frequentist creed."
description: "Introduces the frequentist philosophy of statistics: data as a sample from a population, the data story, probabilistic models, point estimates, and the sampling distribution. Covers MLE for the binomial, and both parametric and non-parametric bootstrap for uncertainty estimation."
categories:
    - statistics
    - probability
date: 2025-01-22
...
![Binomial distribution for various values of p](distrib-example/assets/binomial.png)

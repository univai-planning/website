...
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-9-output-1.png)
...
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-11-output-1.png)
...
plt.ylim([0.25,0.75]);
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-12-output-1.png)
...
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-14-output-1.png)
...
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-15-output-1.png)
...
plt.xlabel("$x$");
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-16-output-1.png)
...
plt.xscale("log");
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-17-output-1.png)
...
```
![Figure](https://univ.ai/learning/samplingclt/index_files/figure-html/cell-18-output-1.png)

...
```
![Figure](https://univ.ai/learning/introgibbs/index_files/figure-html/cell-4-output-1.png)
...
plt.show()
```
![Figure](https://univ.ai/learning/introgibbs/index_files/figure-html/cell-8-output-1.png)
...
```
![Figure](https://univ.ai/learning/introgibbs/index_files/figure-html/cell-9-output-1.png)
...
```
![Figure](https://univ.ai/learning/introgibbs/index_files/figure-html/cell-10-output-1.png)

<!-- cell:19 type:code -->
```python
corrplot(out[4000:,1], 100)
```
![Figure](https://univ.ai/learning/introgibbs/index_files/figure-html/cell-11-output-1.png)

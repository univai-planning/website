...
```
![Figure](https://univ.ai/learning/em/index_files/figure-html/cell-6-output-1.png)
...
Output:
```
array([0.40517661, 0.8071242 , 0.80421864, 0.38565252, 0.86813013,
       0.88858681, 0.70749728, 0.44321506, 0.81360971, 0.49601632,
       0.13391219, 1.07817521, 0.42119403, 0.18646692, 0.82138976,
       0.57930355, 0.51122901, 0.71391896, 0.82300612, 0.19955746])
```
...
plt.hist(x, bins=20);
```
![Figure](https://univ.ai/learning/em/index_files/figure-html/cell-13-output-1.png)

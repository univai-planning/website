...
```
![Figure](https://univ.ai/learning/gradientdescent/index_files/figure-html/cell-7-output-1.png)
...
```
![Figure](https://univ.ai/learning/gradientdescent/index_files/figure-html/cell-13-output-1.png)
...
/var/folders/wq/mr3zj9r14dzgjnq9rjx_vqbc0000gn/T/ipykernel_48766/2428721890.py:17: UserWarning: The following kwargs were not used by contour: 'color'
  ax.contour(M, B, Z, 20, color='b', alpha=0.5, offset=0, stride=30)
```
![Figure](https://univ.ai/learning/gradientdescent/index_files/figure-html/cell-17-output-2.png)
...
```
![Figure](https://univ.ai/learning/gradientdescent/index_files/figure-html/cell-21-output-1.png)
...
/var/folders/wq/mr3zj9r14dzgjnq9rjx_vqbc0000gn/T/ipykernel_48766/2428721890.py:17: UserWarning: The following kwargs were not used by contour: 'color'
  ax.contour(M, B, Z, 20, color='b', alpha=0.5, offset=0, stride=30)
```
![Figure](https://univ.ai/learning/gradientdescent/index_files/figure-html/cell-22-output-2.png)
...
```
![Figure](https://univ.ai/learning/gradientdescent/index_files/figure-html/cell-23-output-1.png)

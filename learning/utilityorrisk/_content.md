...
```
![Figure](https://univ.ai/learning/utilityorrisk/index_files/figure-html/cell-4-output-1.png)
...
```
![Figure](https://univ.ai/learning/utilityorrisk/index_files/figure-html/cell-6-output-1.png)
...
```
![Figure](https://univ.ai/learning/utilityorrisk/index_files/figure-html/cell-8-output-1.png)
...
plt.legend(loc="upper left");
```
![Figure](https://univ.ai/learning/utilityorrisk/index_files/figure-html/cell-9-output-1.png)

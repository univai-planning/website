...
```
![Figure](https://univ.ai/learning/montecarlointegrals/index_files/figure-html/cell-8-output-3.png)
...
```
![Figure](https://univ.ai/learning/montecarlointegrals/index_files/figure-html/cell-9-output-2.png)
...
![Rectangle rule for numerical integration](https://upload.wikimedia.org/wikipedia/commons/5/5b/Rectangle_rule.gif)

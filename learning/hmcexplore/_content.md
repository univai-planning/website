...
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-4-output-1.png)
...
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-5-output-1.png)
...
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-6-output-1.png)
Output:
```
...
Text(0, 0.5, 'H')
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-7-output-2.png)
...
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-8-output-2.png)
...
accept= 1.0
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-11-output-2.png)
...
accept= 0.2961
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-13-output-2.png)
...
plt.title('hmc');
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-14-output-1.png)
...
plt.title('mh');
```
![Figure](https://univ.ai/learning/hmcexplore/index_files/figure-html/cell-15-output-1.png)

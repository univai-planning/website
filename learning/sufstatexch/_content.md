...
plt.legend();
```
![Figure](https://univ.ai/learning/sufstatexch/index_files/figure-html/cell-4-output-1.png)
...
```
![Figure](https://univ.ai/learning/sufstatexch/index_files/figure-html/cell-11-output-1.png)

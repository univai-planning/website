...
2
```
![Figure](https://univ.ai/learning/validation/index_files/figure-html/cell-12-output-2.png)
...
2
```
![Figure](https://univ.ai/learning/validation/index_files/figure-html/cell-14-output-2.png)
...
plt.yscale("log")
```
![Figure](https://univ.ai/learning/validation/index_files/figure-html/cell-16-output-1.png)

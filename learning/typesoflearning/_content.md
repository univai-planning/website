...
```
![Figure](https://univ.ai/learning/typesoflearning/index_files/figure-html/cell-7-output-1.png)
...
sns.histplot(x, bins=100, kde=True);
```
![Figure](https://univ.ai/learning/typesoflearning/index_files/figure-html/cell-8-output-1.png)
...
```
![Figure](https://univ.ai/learning/typesoflearning/index_files/figure-html/cell-11-output-1.png)

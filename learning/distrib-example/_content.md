...
```
![Figure](https://univ.ai/learning/distrib-example/index_files/figure-html/cell-5-output-2.png)
...
```
![Figure](https://univ.ai/learning/distrib-example/index_files/figure-html/cell-10-output-1.png)
...
```
![Figure](https://univ.ai/learning/distrib-example/index_files/figure-html/cell-12-output-1.png)
...
q=plt.xlabel("$k$")
```
![Figure](https://univ.ai/learning/distrib-example/index_files/figure-html/cell-13-output-1.png)
...
```
![Figure](https://univ.ai/learning/distrib-example/index_files/figure-html/cell-18-output-1.png)
